...
- 2026-06-02 - Game Boy Color faceplate skin: toggle wraps the screen in a purple GBC body (power LED, brand, screen bezel) with an authentic D-pad (reuses the 8-way input mapping), round A/B and Start/Select; persisted; reuses simulateInput - pending
