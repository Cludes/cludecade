...
- 2026-06-02 - Game Boy skin: make it immersive (hide header/footer, centre + enlarge the console, slim the control bar to Now playing/Change game + toggles) and gate skin styling to only apply while a game is running so the picker stays clean and loadable - pending
