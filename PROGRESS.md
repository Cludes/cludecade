...
- 2026-06-02 - Two-view home: the landing now shows only the console grid (+ recent); picking a console opens a load view (file/drag-drop/built-in/URL) for it with a back button. Selecting forces that core - pending
