...
- 2026-06-02 - Console-select front page (stage 2): grid of consoles on the picker; selecting one forces that core for the next ROM (so disc/ambiguous formats load without guessing). Also skip quick-resume caching for ROMs >48MB - pending
